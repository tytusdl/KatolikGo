...
| `mockups/mockup-v1.html` | **Frozen snapshot** (v10 final, user-approved) | Reference for "approved direction". Do NOT overwrite on subsequent iterations. Bump to `mockup-v2.html` when user approves next major direction. |

**Design direction (v1 baseline):**
